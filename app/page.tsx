        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="max-w-xl">
            ...
            <p className="mt-6 text-lg text-gray-700">
              We built a personal finance manager that feels like family — not a
              spreadsheet. Our KutumbKhata 💱 tracks your OTT, doodh 🥛, and
              even ₹20 daily savings 💰.
            </p>
      ...
      <section id="features" className="container mx-auto px-4 py-16 md:py-24">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-lg text-gray-700 max-w-3xl mx-auto">
            We don't just show numbers — we help real Indian families 👨‍👩‍👧‍👦 build
            smarter habits, not just boring charts. 😎
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-white p-8 rounded-xl shadow-[0_8px_30px_-6px_rgba(234,88,12,0.2)] hover:shadow-[0_12px_40px_-6px_rgba(234,88,12,0.3)] transition-all duration-300">
            ...
            <p className="text-gray-700">
              Add income or expenses in less than 10 seconds. Our AI
              automatically categorizes your entries.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl shadow-[0_8px_30px_-6px_rgba(234,88,12,0.2)] hover:shadow-[0_12px_40px_-6px_rgba(234,88,12,0.3)] transition-all duration-300">
            ...
            <p className="text-gray-700">
              Visual breakdowns of your spending habits and trends to help you
          ...
          <div className="bg-white p-8 rounded-xl shadow-[0_8px_30px_-6px_rgba(234,88,12,0.2)] hover:shadow-[0_12px_40px_-6px_rgba(234,88,12,0.3)] transition-all duration-300">
            ...
            <p className="text-gray-700">
              Never miss a payment again. Get friendly reminders for upcoming
              bills and subscription renewals.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl shadow-[0_8px_30px_-6px_rgba(234,88,12,0.2)] hover:shadow-[0_12px_40px_-6px_rgba(234,88,12,0.3)] transition-all duration-300">
            ...
            <p className="text-gray-700">
              Get personalized suggestions based on your spending patterns to
              help you save more and spend wisely.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl shadow-[0_8px_30px_-6px_rgba(234,88,12,0.2)] hover:shadow-[0_12px_40px_-6px_rgba(234,88,12,0.3)] transition-all duration-300">
            ...
            <p className="text-gray-700">
              Track expenses for the whole family. See who's spending what and
              manage family budgets together.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl shadow-[0_8px_30px_-6px_rgba(234,88,12,0.2)] hover:shadow-[0_12px_40px_-6px_rgba(234,88,12,0.3)] transition-all duration-300">
            ...
            <p className="text-gray-700">
              Keep track of all your investments in one place, whether they're
        ...
        <div className="bg-orange-600 text-white rounded-2xl p-8 md:p-12">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl mb-8">
              Join thousands of families who are building better financial
              habits with KutumbKhata.
            </p>
            <Link href="/auth/register">
